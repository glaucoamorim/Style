...
xmlhandler, countMedias = createsProperties(xmlhandler, countMedias)
xmlhandler, countMedias, layoutTable = createsMediaLua(xmlhandler, countMedias)
xmlhandler = createsLinks(xmlhandler)
